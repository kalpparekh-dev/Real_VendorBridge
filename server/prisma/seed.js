...
async function main() {
    ...
    const procurementOfficer = await prisma.user.create({
        data: {
            ...
            password: hashedPassword,
            role: client_1.Role.PROCUREMENT_OFFICER,
        },
    });
    ...
    const quotation1 = await prisma.quotation.create({
        data: {
            ...
            status: client_1.QuotationStatus.SUBMITTED,
            items: {
                create: [
    ...
    const quotation2 = await prisma.quotation.create({
        data: {
            ...
            status: client_1.QuotationStatus.UNDER_REVIEW,
            items: {
                create: [
    ...
    const po = await prisma.purchaseOrder.create({
        data: {
            ...
            status: client_1.POStatus.ISSUED,
        },
    });
